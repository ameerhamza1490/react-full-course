  ...
  return (
    <div className=" bg-black text-white">
      <div className="flex flex-col lg:flex-row md:flex-col sm:flex-col h-full">
        <div
          className="w-full pt-20 px-10 flex
        flex-col gap-10s"
        >
        ...
        <div className="lg:w-10/10 lg:border-l-2 pt-10 lg:pt-20 px-10 ">
          <h1 className="text-4xl font-bold">Recent Notes</h1>
          <div className="grid grid-cols-2 lg:grid-cols-3 md:grid-cols-5 sm:grid-cols-4  items-start justify-start gap-5 mt-6">
            {task.map((elem, indx) => (
              <div
                key={indx}
